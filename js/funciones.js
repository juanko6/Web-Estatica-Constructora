...
function tipo(imagen) {
  ...
  divtexto.innerHTML = "<p>Hall de acceso. <br>Sala Comedor. Cocina Abierta. <br>* Area de Ropas. <br> 3 Habitaciones. <br>2 Baños.<br> <br> Área Construida 62.32 m² <br> Área Privada 55.56 m² <br><br> Diseño Inteligente: <br>Todos los espacios iluminados y ventilados naturalmente. <br> <br>Únicos en el sector con area construida de: <h2>62.32 m²</h2></p > "
...
function bloque1(){
  etapa_1.style.visibility = 'visible';
  etapa_2.style.visibility = 'hidden';
  etapa_3.style.visibility = 'hidden';
  etapa_4.style.visibility = 'hidden';
}


function bloque2(){
  etapa_1.style.visibility = 'hidden';
  etapa_2.style.visibility = 'visible';
  etapa_3.style.visibility = 'hidden';
  etapa_4.style.visibility = 'hidden';
...
function bloque3(){
  etapa_1.style.visibility = 'hidden';
  etapa_2.style.visibility = 'hidden';
  etapa_3.style.visibility = 'visible';
  etapa_4.style.visibility = 'hidden';
...
function bloque4(){
  ...
  etapa_2.style.visibility = 'hidden';
  etapa_3.style.visibility = 'hidden';
  etapa_4.style.visibility = 'visible';
